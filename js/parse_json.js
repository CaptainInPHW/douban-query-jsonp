!function () {
    window.ParseBooksJSON = function (json) {
        ...
        for (let i = 0; i < booksNumber; i++) {
            let bookTemplete = `<div class="col-12 col-md-6 item"><div class="row"><div class="col-4 col-md-3 book-image"></div><div class="col-8 col-md-9"><ul class="list-group"><li class="list-group-item"><a href="" class="book-title">${query.parsedDoubanData.books[query.searchContent][i].title}</a></li><li class="list-group-item author">作者：<a href="" class="author-name">${query.parsedDoubanData.books[query.searchContent][i].author}</a></li><li class="list-group-item publisher">出版社：<span class="publisher-name">${query.parsedDoubanData.books[query.searchContent][i].publisher}</span></li><li class="list-group-item pubdate">出版年：<span class="date">${query.parsedDoubanData.books[query.searchContent][i].pubdate}</span></li> <li class="list-group-item price">定价：<span class="currency-icon">￥</span><span class="price-number">${query.parsedDoubanData.books[query.searchContent][i].price}</span></li> <li class="list-group-item rating">评分：<span class="average-rating">${query.parsedDoubanData.books[query.searchContent][i].rating}</span></li> <li class="list-group-item ISBN">ISBN：<span class="ISBN-number">${query.parsedDoubanData.books[query.searchContent][i].ISBN}</span></li></ul> </div> </div> </div>`;
    ...
    window.ParseMoviesJSON = function (json) {
        ...
        $showBooksArea.empty();
        for (let i = 0; i < booksNumber; i++) {
            let movieTemplete = `<div class="col-12 col-md-6 item"><div class="row"><div class="col-4 col-md-3 book-image"></div><div class="col-8 col-md-9"><ul class="list-group"><li class="list-group-item"><a href="" class="book-title">${query.parsedDoubanData.movies[query.searchContent][i].title}</a></li><li class="list-group-item author">导演：<a href="" class="author-name">${query.parsedDoubanData.movies[query.searchContent][i].director}</a></li><li class="list-group-item publisher">主演：<span class="publisher-name">${query.parsedDoubanData.movies[query.searchContent][i].cast}</span></li><li class="list-group-item pubdate">上映时间：<span class="date">${query.parsedDoubanData.movies[query.searchContent][i].pubdate}</span></li> <li class="list-group-item price">类型：${query.parsedDoubanData.movies[query.searchContent][i].genre}</li> <li class="list-group-item rating">评分：<span class="average-rating">${query.parsedDoubanData.movies[query.searchContent][i].rating}</span></li></ul></div></div></div>`;
